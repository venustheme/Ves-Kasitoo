...
## Free Magento 2 theme For Furniture Store, Decorative store

Venus proudly introduces [Kasitoo](http://www.venustheme.com/theme/ves-kasitoo/), a new free magento2 theme for an online store. It will be perfect for fashion, Shoes, Glasses, Equipment and so on. Ves Kashi too comes with product-oriented design that attracts customers at the first sight.


## 1. Documentation

- Installation guide: http://venustheme.com/guides/ves_kasitoo/
- Download from our Live site: http://www.venustheme.com/theme/ves-kasitoo/
...
This free magento 2 theme will scale to fit any devices perfectly. Especially this is magento 2 theme download free

### Touch Optimized Deal products carousel
Touch optimized feature on smart devices like smartphone and tablets will bring your customer amazing shopping experience ever. Your deal products will be shown prominently.

### Product tabs carousel by rules
Ves Kasitoo- Free magento 2 Furniture theme lets you showcase multiple type of product list by rules such as latest, new, mostview, bestseller.


### Off Canvas Menu
This Magento 2 Free theme comes with off canvas menu. The off-canvas navigation menu is one of the vital solutions for store on mobile today.

### Inherited from magento 2.0 blank theme & use Magento 2.0 UI
Being inherited from magento 2 blank theme and use magento 2.0 UI, this free magento 2 theme not only run fast but it also looks amazing.


### Free Magento 2 Theme with Fast Checkout
Fast checkout process require minimum steps and infomation that helps you lower redundant rate


### Fast page load time
Fast site sell more! Magento 2 delivers speed with fast page load time for home, category, product detail on first view.


### PSD included
As you may know, all PSD file will be included in the package. It is free for you to use and customize.

### Compatible With Marketplace Extension
Ves Kasitoo is compatible with LandOfCoder MultiVendor Marketplace and other most popular Magento extensions from #1 provider such as LandOfCoder.
